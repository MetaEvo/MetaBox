...
| F8 | Modified Rastrigin          | D   | $\prod  k_i$          | 0            | $[0, 1]^D$            |
...
|----------- | ----------- |---| ------------------- | ----------- |
|P1      | $F_1$ (1D)  | 0.01 |-200.0 |2|
|P2      | $F_2$ (1D) | 0.01| -1.0 |5|
|P3      | $F_3$ (1D)| 0.01 |-1.0 |1|
|P4      | $F_4$ (2D) | 0.01| -200.0| 4|
|P5      | $F_5$ (2D) | 0.5 |-1.031628453| 2|
|P6      | $F_6$ (2D) | 0.5| -186.7309088 |18|
|P7      | $F_7$ (2D)| 0.2| -1.0| 36|
|P8      | $F_6$ (3D) | 0.5 |-2709.093505| 81|
|P9      | $F_7$ (3D)| 0.2 |-1.0| 216|
|P10     | $F_8$ (2D) | 0.01| 2.0| 12|
|P11     | $F_9$ (2D)| 0.01| 0| 6|
|P12     | $F_{10}$ (2D)| 0.01 |0| 8|
|P13    | $F_{11}$ (2D) | 0.01| 0| 6|
|P14    | $F_{11}$ (3D)| 0.01| 0| 6|
|P15    | $F_{12}$ (3D)| 0.01| 0| 8|
|P16    | $F_{11}$ (5D)| 0.01| 0 |6|
|P17    | $F_{12}$ (5D) | 0.01| 0| 8|
|P18    | $F_{11}$ (10D) | 0.01 |0| 6|
|P19    | $F_{12}$ (10D)|0.01| 0 |8|
|P20    | $F_{12}$ (20D) |0.01 |0| 8|
