...
In Metaevobox, we give three benchmark split difficulty mode of both train and test from the ten tasks of WCCI2020 as **easy**, **difficult** and **full**. The benchmark split criterion is according to the richness of the composition of the basic functions.  
