...
class NE_Dataset(Dataset):
    """
    # Introduction
    NE_Dataset is a dataset wrapper designed for handling collections of NE_Problem instances, supporting batching, shuffling, and flexible dataset construction for training and testing in neural environment (NE) tasks.
    # Original paper
